...
<jsp:include page="header.jsp" />
    ...
    <main>
        ...
        <section class="forum-header">
            <div class="bg-element bg-pink"></div>
            
            <div class="forum-header-content">
                <div class="forum-category-icon bg-pink">
                    <i data-lucide="radio"></i>
                </div>
                
                <div class="forum-header-text">
                    <h1 class="forum-title">
                        <span class="text-cyber-pink">Indie</span> Scene
                    </h1>
                    
                    <p class="forum-description">
                        Independent games, upcoming releases, and hidden gems.
                        Discover unique experiences from innovative developers.
                    </p>
                    
                    <div class="forum-stats">
                        <div class="forum-stat">
                            <i data-lucide="message-square"></i>
                            <span>724 Topics</span>
                        </div>
                        <div class="forum-stat">
                            <i data-lucide="users"></i>
                            <span>3,127 Members</span>
                        </div>
                        <div class="forum-stat">
            ...
            <div class="threads-list">
                ...
                <a href="#" class="thread-item pinned">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            ...
                            <h3 class="thread-title">Indie Scene Forum Rules & Guidelines - Read Before Posting</h3>
                        </div>
                    </div>
                    ...
                    <div class="thread-activity">
                        <span class="activity-time">Mar 18, 2025</span>
                    </div>
                </a>
                ...
                <a href="#" class="thread-item hot">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            ...
                            <h3 class="thread-title">Hollow Knight: Silksong - Release Date Speculation</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=70" alt="SilkSinger" class="author-avatar">
                        <span class="author-name">SilkSinger</span>
                    </div>
                    <div class="thread-replies">87</div>
                    <div class="thread-views">2,435</div>
                    <div class="thread-activity">
                ...
                <a href="#" class="thread-item">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            <h3 class="thread-title">Indie Devs Showcase - Share Your Work In Progress!</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=71" alt="PixelProgrammer" class="author-avatar">
                        <span class="author-name">PixelProgrammer</span>
                    </div>
                    <div class="thread-replies">42</div>
                    <div class="thread-views">1,124</div>
                    <div class="thread-activity">
                ...
                <a href="#" class="thread-item">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            <h3 class="thread-title">Hidden Indie Gems of 2025 - Games You Must Play</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=72" alt="IndieExplorer" class="author-avatar">
                        <span class="author-name">IndieExplorer</span>
                    </div>
                    <div class="thread-replies">29</div>
                    <div class="thread-views">984</div>
                    <div class="thread-activity">
                ...
                <a href="#" class="thread-item">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            <h3 class="thread-title">Kickstarter Roundup - Promising Indie Projects to Back</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=73" alt="CrowdFunder" class="author-avatar">
                        <span class="author-name">CrowdFunder</span>
                    </div>
                    <div class="thread-replies">18</div>
                    <div class="thread-views">612</div>
                    <div class="thread-activity">
        ...
        <section class="forum-cta">
            <div class="cta-content">
                <h2 class="cta-title">Join the <span class="text-cyber-pink">Indie</span> Movement</h2>
                <p class="cta-description">
                    Discover innovative games, support independent developers, and share hidden gems.
                </p>
                 <a button href="CreateNewPost.jsp" class="cyber-button purple-glow">
                    <i data-lucide="plus"></i>
                     Create New Post
