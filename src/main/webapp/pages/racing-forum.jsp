    ...
    <main>
        ...
        <section class="forum-header">
            ...
            <div class="forum-header-content">
                <div class="forum-category-icon bg-yellow">
                    <i data-lucide="car"></i>
                </div>
                
                <div class="forum-header-text">
                    <h1 class="forum-title">
                        <span class="text-cyber-yellow">Racing</span> Games
                    </h1>
                    
                    <p class="forum-description">
                        Racing games, driving simulators, and vehicle customization.
                        Share your fastest laps, car builds, and racing strategies.
                    </p>
                    
                    <div class="forum-stats">
                        <div class="forum-stat">
                            <i data-lucide="message-square"></i>
                            <span>632 Topics</span>
                        </div>
                        <div class="forum-stat">
                            <i data-lucide="users"></i>
                            <span>3,945 Members</span>
                        </div>
                        <div class="forum-stat">
            ...
            <div class="threads-list">
                ...
                <a href="#" class="thread-item pinned">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            ...
                            <h3 class="thread-title">Racing Forum Rules & Guidelines - Read Before Posting</h3>
                        </div>
                    </div>
                    ...
                    <div class="thread-views">2,451</div>
                    <div class="thread-activity">
                        <span class="activity-time">Mar 10, 2025</span>
                    </div>
                </a>
                ...
                <a href="#" class="thread-item hot">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            ...
                            <h3 class="thread-title">Forza Motorsport 2025 - Release Date & Feature Wishlist</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=40" alt="SpeedRacer" class="author-avatar">
                        <span class="author-name">SpeedRacer</span>
                    </div>
                    <div class="thread-replies">62</div>
                    <div class="thread-views">1,892</div>
                    <div class="thread-activity">
                ...
                <a href="#" class="thread-item">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            <h3 class="thread-title">Best Racing Wheel Setup Under $500 - 2025 Guide</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=41" alt="SimRacer101" class="author-avatar">
                        <span class="author-name">SimRacer101</span>
                    </div>
                ...
                <a href="#" class="thread-item">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            <h3 class="thread-title">Gran Turismo 8 vs Forza: Which Has Better Physics?</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=42" alt="DriftKing" class="author-avatar">
                        <span class="author-name">DriftKing</span>
                    </div>
                    <div class="thread-replies">87</div>
                    <div class="thread-views">2,317</div>
                    <div class="thread-activity">
                ...
                <a href="#" class="thread-item">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            <h3 class="thread-title">F1 2025 - Career Mode Tips and Team Selection Guide</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=43" alt="F1Champion" class="author-avatar">
                        <span class="author-name">F1Champion</span>
                    </div>
                    <div class="thread-replies">29</div>
                    <div class="thread-views">943</div>
                    <div class="thread-activity">
        ...
        <section class="forum-cta">
            <div class="cta-content">
                <h2 class="cta-title">Join the <span class="text-cyber-yellow">Race</span></h2>
                <p class="cta-description">
                    Share your racing experiences, setups, and strategies with fellow racing enthusiasts.
                </p>
                 <a button href="CreateNewPost.jsp" class="cyber-button purple-glow">
                    <i data-lucide="plus"></i>
                     Create New Post
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="footer-bottom">
                ...
                <p class="made-with">
                    Made with <i data-lucide="heart" class="text-cyber-red"></i> in the Cyberpunk Universe
                </p>
            </div>
        </div>
    </footer>
