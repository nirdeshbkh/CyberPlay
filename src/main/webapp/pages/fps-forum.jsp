    ...
    <main>
        ...
        <section class="forum-header">
            ...
            <div class="forum-header-content">
                <div class="forum-category-icon bg-red">
                    <i data-lucide="target"></i>
                </div>
                
                <div class="forum-header-text">
                    <h1 class="forum-title">
                        <span class="text-cyber-red">FPS</span> Games
                    </h1>
                    
                    <p class="forum-description">
                        First-person shooters, tactical shooters, and arena combat games.
                        Share strategies, gameplay clips, and competitive insights.
                    </p>
                    
                    <div class="forum-stats">
                        <div class="forum-stat">
                            <i data-lucide="message-square"></i>
                            <span>1,342 Topics</span>
                        </div>
                        <div class="forum-stat">
                            <i data-lucide="users"></i>
                            <span>7,218 Members</span>
                        </div>
                        <div class="forum-stat">
                            <i data-lucide="calendar"></i>
                            <span>Last post: 5 minutes ago</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="threads-list">
                ...
                <a href="#" class="thread-item pinned">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            ...
                            <h3 class="thread-title">FPS Forum Rules & Guidelines - Read Before Posting</h3>
                        </div>
                    </div>
                    ...
                    <div class="thread-views">4,782</div>
                    <div class="thread-activity">
                        <span class="activity-time">Mar 15, 2025</span>
                    </div>
                </a>
                ...
                <a href="#" class="thread-item hot">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            ...
                            <h3 class="thread-title">Call of Duty: Black Ops 6 Rumored Features & Release Date</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=20" alt="SpecOps_Ghost" class="author-avatar">
                        <span class="author-name">SpecOps_Ghost</span>
                    </div>
                    <div class="thread-replies">112</div>
                    <div class="thread-views">3,405</div>
                    <div class="thread-activity">
                ...
                <a href="#" class="thread-item">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            <h3 class="thread-title">Valorant: Best Agents for Solo Queue in 2025</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=21" alt="TacticalSage" class="author-avatar">
                        <span class="author-name">TacticalSage</span>
                    </div>
                    <div class="thread-replies">67</div>
                    <div class="thread-views">1,843</div>
                    <div class="thread-activity">
                ...
                <a href="#" class="thread-item">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            <h3 class="thread-title">Battlefield 2042: Season 8 Disappointment Thread</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=22" alt="BattleVet" class="author-avatar">
                        <span class="author-name">BattleVet</span>
                    </div>
                    <div class="thread-replies">93</div>
                    <div class="thread-views">2,156</div>
                    <div class="thread-activity">
                ...
                <a href="#" class="thread-item">
                    <div class="thread-topic">
                        ...
                        <div class="thread-content">
                            <h3 class="thread-title">Mouse & Keyboard Settings for Competitive FPS Gaming</h3>
                        </div>
                    </div>
                    <div class="thread-author">
                        <img src="https://i.pravatar.cc/150?img=23" alt="AimMaster" class="author-avatar">
                        <span class="author-name">AimMaster</span>
                    </div>
                    <div class="thread-replies">54</div>
                    <div class="thread-views">1,678</div>
                    <div class="thread-activity">
        ...
        <section class="forum-cta">
            <div class="cta-content">
                <h2 class="cta-title">Join the <span class="text-cyber-red">Conversation</span></h2>
